...
uint32_t m_lightChangeDuration = 10;
...
void make_HTML01() {
	...
	*/
	...
	strcat(HTML_String, "<option value=\"2\">rainbow change</option>");
...
void rainbowCycle(uint8_t wait) {
	...
	if (currentTimeSinceEpoch > m_lastEffectTime + wait)
	{
		m_lastEffectTime = currentTimeSinceEpoch;
